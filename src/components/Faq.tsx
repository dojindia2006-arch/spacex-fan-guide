const faqs = [
  {
    ...
    a: "아니요. 이 사이트는 비공식 팬 주도진의 정보 페이지이며, SpaceX·Tesla·xAI 또는 관련 임직원과 아무런 제휴·후원 관계가 없습니다.",
  },
  {
    q: "SpaceX 주식을 살 수 있나요?",
    a: "SpaceX(티커 SPCX)는 2026년 6월 나스닥에 상장되었습니다. 이 사이트는 증권·중개 링크를 제공하지 않으며, 시세는 참고용입니다.",
  },
  {
    q: "여기에 표시된 시세는 실시간인가요?",
    a: "공개 시세 데이터를 주기적으로 불러오며, 거래소 실시간과 다를 수 있고 지연될 수 있습니다. 매매에 쓰기 전에 증권사·거래소 등 공식 채널을 확인하세요.",
  },
  {
  ...
  },
  {
    ...
    a: "Tesla와 SpaceX는 별도 법인입니다. Tesla 주식을 보유한다고 해서 SpaceX 지분을 직접 갖는 것은 아닙니다.",
  },
  {
    q: "Starlink·xAI·Grok도 SpaceX인가요?",
    a: "Starlink는 SpaceX의 위성 인터넷 사업입니다. Grok은 xAI에서 출발한 AI 어시스턴트이고, xAI/SpaceXAI는 창업자·자본 측면에서 SpaceX와 가깝게 연결·재편되었다는 보도가 있습니다(시점에 따라 설명이 달라질 수 있음). 로켓·스타링크와 AI·소셜은 성격이 다른 축입니다. 이 사이트는 어느 쪽도 공식 대변하지 않습니다.",
  },
  {
    q: "정보를 어디에 근거하나요?",
