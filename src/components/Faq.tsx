const faqs = [
  ...
  },
  {
    ...
    a: "Starlink는 SpaceX의 위성 인터넷 사업입니다. Grok은 xAI에서 출발한 AI 어시스턴트이고, xAI/SpaceXAI는 창업자·자본 측면에서 SpaceX와 가깝게 연결·재편되었다는 보도가 있습니다(시점에 따라 설명이 달라질 수 있음). 로켓·스타링크와 AI·소셜은 성격이 다른 축입니다.",
  },
  {
    q: "정보를 어디에 근거하나요?",
